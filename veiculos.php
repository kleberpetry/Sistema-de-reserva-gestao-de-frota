      ...
      <form id="form-reserva" class="reserva">
        <div class="date-inputs">
          <div class="row">
            <div class="input-field col s6">
              <input id="dataSaida" type="text" class="datepicker validate datetime-input" autocomplete="off" required>
              <label for="dataSaida">Data saída</label>
            </div>
            <div class="input-field col s6">
              <input id="dataRetorno" type="text" class="datepicker validate datetime-input" autocomplete="off" required>
              <label for="dataRetorno">Data retorno</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s6">
              <input id="horarioSaida" type="text" class="timepicker validate datetime-input" autocomplete="off" required>
              <label for="horarioSaida">Horário Saída</label>
            </div>
            <div class="input-field col s6">
              <input id="horarioRetorno" type="text" class="timepicker validate datetime-input" autocomplete="off" required>
        ...
        <div class="selecionar-veiculo">
          <div class="input-field">
            <select id="veiculo" required disabled>
              ...
              <?php foreach ($veiculos as $veiculo) { ?>
                <option value="<?php echo $veiculo["id_veiculo"] ?>"><?php echo $veiculo["modelo"] ?><?php echo " - "?><?php echo $veiculo["placa"] ?></option>
              <?php } ?>
            </select>
            <label>Veículo</label>
          </div>
